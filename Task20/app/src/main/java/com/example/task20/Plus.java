...
public class Plus extends RoundedButton {
    int color;
    int rectWidth;
    int rectHeight;
    int startX;
    int startY;
    public Plus(Context context, int color) {
        super(context, color);
        this.color = color;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(this.startY, this.startX, this.startY + this.rectHeight, this.startX + this.rectWidth, paint);
    }
}
